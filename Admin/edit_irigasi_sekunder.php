<html>
<body>
<form name="form1" method="post" action="aksi_edit_irigasi_sekunder.php"> 
     ...
     <?php 
      ...
      $sqlTampil="select * from tb_sekunder Where No2='$_GET[id]'"; 
    ...
    <tr bgcolor="#FFFFFF"> 
          ...
          <td>: 
          <input name="no" type="text" id="no" value="<?php echo $dataTampil['NO2']; ?>"></td> 
        </tr> 
		<tr bgcolor="#FFFFFF"> 
